...
<body>
  ...
  $sql = "SELECT * FROM product"; // Replace 'your_table_name' with the actual table name
...
<div class="admin-content">
    <div class="container">
        ...
        <section id="productList" class="product-list-content" style="text-align: center; color: black;">
            <h2>Product List</h2>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      // Buttons
                        ...
                        echo '<a href="productview.php?id=' . $row['ProductID'] . '" class="btn btn-info btn-sm mx-1">View</a>';
                        echo '<a href="productviewupdate.php?id=' . $row['ProductID'] . '" class="btn btn-primary btn-sm mx-1">Update</a>';
                        echo '<a href="productdelete.php?id=' . $row['ProductID'] . '" class="btn btn-danger btn-sm mx-1" onclick="return confirm(\'Are you sure you want to delete this product?\')">Delete</a>';                        echo '</td>';
                        echo "</tr>";
                    }
