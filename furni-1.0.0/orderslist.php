...
<body>
  ...
  $sql = "SELECT * FROM cart"; // Replace 'your_table_name' with the actual table name
  ...
  <div class="admin-content">
    <div class="container">
      ...
      <!-- Order List Content -->
      <section id="orderList" class="account-list-content" style="text-align: center; color: black;">
        <h2>Order List</h2>
        <!-- Order List Table -->
        <table class="table">
          <thead>
          ...
          <tbody>
            ...
            echo '<a href="cartview.php?id=' . $row['cart_id'] . '" class="btn btn-info btn-sm mx-1">View</a>';
            echo '<a href="cartviewupdate.php?id=' . $row['cart_id'] . '" class="btn btn-primary btn-sm mx-1">Update</a>';
            echo '<a href="cartdelete.php?id=' . $row['cart_id'] . '" class="btn btn-danger btn-sm mx-1" onclick="return confirm(\'Are you sure you want to delete this product?\')">Delete</a>';   
            echo '</td>';
            echo "</tr>";
            }
            ?>
